<div class="afbf_feedback_poles">
	...
	<div class="form-header"><div class="text"><div class="title">Оставьте заявку</div><p>Заполните данные ниже  и мы обязательно с вами свяжемся.</p></div></div>
...
<?		echo bitrix_sessid_post()?>
		<div class="afbf_submit_block">
			<input type="submit" class="fb_close afbf_btn" id="fb_close_<?=$ALX?>" name="SEND_FORM" value="Заказать услугу" />
		</div>
	</form>
